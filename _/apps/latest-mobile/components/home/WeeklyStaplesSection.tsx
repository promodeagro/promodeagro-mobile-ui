...
import { ChevronDown, Minus, Plus, RotateCcw, X } from "lucide-react-native";
import { useState } from "react";
import { Modal, ScrollView, Text, TouchableOpacity, View } from "react-native";
import { useCart } from "../../utils/CartContext";

export function WeeklyStaplesSection({ items }: { items: any[] }) {
            ...
            return (
              ...
              >
                <View style={{ position: "relative", height: 100 }}>
                  ...
                  {/* Show only one badge with priority: out of stock > discount > featured */}
